$(document).ready(function() {
					...
					var secondArray_0 = new Array("자바", "c언어", "파이썬", "c++",
							"c#");
					var secondArray_1 = new Array("영어", "불어", "중국어", "일본어",
							"한국어");
					var secondArray_2 = new Array("정보처리기사", "컴퓨터활용", "ccna",
							"ccnp", "네트워크관리사");
					...
					$("form").submit(
							function() {
								...
								setTimeout(function() {
									// ajax를 사용해서 검색을 하면 바로 화면이 전환되어 검색이 적용됬는지
									// 확인하기 어려워
					...
					$("#firstArray")
							.change(
									function() { // 대분류 선택시 소분류의 값을 선택할수 있도록
										// 한다.
