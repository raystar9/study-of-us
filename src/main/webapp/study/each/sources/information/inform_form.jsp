...
<body>
	<table id='inform_table'>
		...
		<tr>
			<td id='td_title'><strong>*카테고리 (대분류/소분류)</strong></td>
		</tr>
		<tr>
			<td id='shortText'>${set.category1 }&nbsp;/&nbsp;${set.category2 }</td>
		</tr>
		<tr>
			<td id='td_title'><strong>*스터디 원</strong></td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td id='td_title'><strong>*기간</strong></td>
		</tr>
		<tr>
			<td id='shortText'><span>${set.startDate }</span>&nbsp; ~ &nbsp;<span>${set.endDate }</span></td>
		</tr>
		<tr>
			<td id='td_title'><strong>*현재인원 / 최대인원</strong></td>
		</tr>
		<tr>
			<td id='shortText'><span>${membercount }</span>&nbsp;명&nbsp;&nbsp;/ <span>${set.peopleNum }</span>&nbsp;명</td>
		</tr>
		<tr> 
			<td id='td_title'><strong>*활동시간</strong></td>
		</tr>
		<tr>
			<td id='shortText'><span>${set.activityTime }</span></td>
		</tr>
		<tr>
			<td id='td_title'><strong>*요일</strong></td>
		</tr>
		<tr>
			<td id='shortText'><span>${set.day }</span></td>
		</tr>
		<tr>
			<td id='td_title'><strong>*프로젝트 개요</strong></td>
		</tr>
		<tr>
			<td id='longText'>${set.explain }</td>
		</tr>
		<tr>
			<td id='td_title'><strong>*주요 교재 및 준비물</strong></td>
		</tr>
		<tr>
			<td id='longText'>${set.prepared }</td>
		</tr>
		<tr>
			<td id='td_title'><strong>*기대효과 및 활동 분야</strong></td>
		</tr>
		<tr>
			<td id='longText'>${set.effective }</td>
		</tr>
		<tr>
			<td id='td_title'><strong>*스터디 지역</strong></td>
		</tr>
		<tr>
