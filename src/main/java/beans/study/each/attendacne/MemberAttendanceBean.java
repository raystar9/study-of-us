...
public class MemberAttendanceBean {
	public static final String QUERY_GET = "select m_index, m_name, a_attend from studyMemberList, studyMeeting, attend where studyMemberList.s_index = studyMeeting.s_index and mt_id = a_mt_id and a_m_index = m_index and a_mt_id = ?";
