...
public class Study{
	...
	/*
	 * public enum ColumnName{ INDEX("DEPTNO"), ID("DNAME");
	 * 
	 * ColumnName(String str) { _str = str; }
	 * 
	 * private String _str;
	 * 
	 * @Override public String toString() { return _str; }
	 * 
	 * public static String[] getNames() { String[] strings = {INDEX.toString(),
	 * ID.toString()}; return strings; } }
	 */
}
