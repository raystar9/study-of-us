 ...
 */
public class MemberGetIndex implements DataGettable{
	 ...
	 */
	@Override
	public ArrayList<MemberGetIndex> onGetResult(ResultSet rs) throws DatabaseConnectException, SQLException {
		ArrayList<MemberGetIndex> members = new ArrayList<>(); 
		while(rs.next()) {
			MemberGetIndex member = new MemberGetIndex();
