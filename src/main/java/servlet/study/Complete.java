...
public class Complete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 멤버의 인덱스번호 세션받아주고
				...
				// 내가뽑아올 목록을 받아옵니다.
				ArrayList<StudyListSelect2> studyList = getter.getStudyList2(index,page ,limit);
				// 남은일수 뽑아옵니다.
				ArrayList<StudyListSelect2> dday = getter.getDday2(index, page, limit);
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("/study/complete.jsp");
